		...
		<div class="container-fluid pc-padding top-spacer">
			<div class="row tables hidden-xs hidden-sm">
				...
				<div class="col-sm-6 text-center">
					<img alt="Image descriptoin" data-src="/images/about-1.png"  class="about-img">
				</div>
			...
			<div class="row tables section-bottom-spacer top-spacer hidden-sm hidden-xs">
				...
				<div class="col-sm-6 table-centered">
					<p class="pc-section-header text-right">Our Philosophy</p>
					<p class="pc-details-1 text-right default-font-size">Platinum Corp. represents a new age real estate development group, focused on delivering Hi-Tech Value Homes for modern day urban India across high-growth regions at affordable prices through flexible payment plans. </p>
			...
			<div class="row">
				<div class="col-sm-12 text-center pc-section-header" style="margin-top: 30px;"> What our stakeholders say about us</div>
			</div>
